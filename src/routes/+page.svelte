	...
	<div class="p-8 pt-12">
		...
		>
			<li class="mb-10 ml-6">
				...
				<h3 class="font-medium leading-tight">Signin to the app</h3>
			</li>
			<li class="mb-10 ml-6">
				<span
				...
				<h3 class="font-medium leading-tight">Add Accounts Info</h3>
			</li>
			<li class="mb-10 ml-6">
				<span
					class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700"
				...
				<h3 class="font-medium leading-tight">Review your transactions</h3>
			</li>
			<li class="ml-6">
				<span
					class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700"
				...
				<h3 class="font-medium leading-tight">Download your transactions as CSV file</h3>
			</li>
		</ol>
	</div>
</div>
