...
<Card class="" size="full">
  <p class="py-2 text-lg text-gray-800 dark:text-gray-200">
    Select a date range :
  </p>
...
<p class="mt-2 py-2 text-lg text-gray-800 dark:text-gray-200">
Select accounts :
</p>
...
banksIdArray.indexOf(item.institutionId)>
-1
